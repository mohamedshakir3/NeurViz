					...
					<AccordionItem value="item-2">
						...
						<AccordionContent>
							<p className="mb-4 max-w-[600px] text-muted-foreground">
								...
								and limited control. They often come with performance issues
								and make it difficult to integrate with your product.
							</p>
							<p className="mb-4 max-w-[600px] text-muted-foreground">
					...
					<AccordionItem value="item-4">
						...
						<AccordionContent>
							...
							<p className="mb-4 max-w-[580px] text-muted-foreground">
								...
								and future content. Use it for unlimited personal and
